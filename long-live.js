...
// var reactionToRole = {'👻':'Grim','👑':'Heir','🍷':'Advisor','⛪':'Bishop','⚔️':'Captain'};
// var reactionToLocation = {'🪑':'Throne','🍻':'Courtyard','🥂':'Ballroom','🕯️':'Chapel','🛡️':'Barracks'};
// var locationToReaction = {'Throne':'🪑','Courtyard':'🍻','Ballroom':'🥂','Chapel':'🕯️','Barracks':'🛡️'};
// var locationReactions = ['🪑','🍻','🥂','🕯️','🛡️'];
...
//                 .then(() => player.stateMessage.react(locationReactions[0]))
//                 .then(() => player.stateMessage.react(locationReactions[1]))
//                 .then(() => player.stateMessage.react(locationReactions[2]))
//                 .then(() => player.stateMessage.react(locationReactions[3]))
//                 .then(() => player.stateMessage.react(locationReactions[4]))
//                 .catch(console.error);
//         }
